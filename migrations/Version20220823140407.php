 ...
 */
final class Version20220823140407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD organisateur_id INT NOT NULL, ADD lieu_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP organisateur_id, DROP lieu_id');
    }
}
